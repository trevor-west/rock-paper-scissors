...
//   3. Use Math.Random to check the number generated between 0 and 1 and match against the variables for 'Rock', 'Paper', and 'Scissors' and return the value that meets the defined criteria
